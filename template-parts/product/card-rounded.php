...
<li
  ...
  <h3 class="text-lg lg:text-sm m-0 flex-grow w-full leading-normal">
  ...
  <div class="w-60 h-60 md:w-44 md:h-44 rounded-full flex justify-center items-center overflow-hidden mx-auto my-4">
  ...
  <div class="text-md flex-grow relative w-full">
    ...
    <div class="flex justify-between items-center mt-1">
      <div class="selleradise_productCard__price text-sm font-semibold">
