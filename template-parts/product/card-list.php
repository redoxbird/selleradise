...
<li
    x-data="productCard"
    class="<?php echo esc_attr($class); ?> flex justify-start items-stretch rounded-2xl bg-background-900 text-text-900 border-1 border-gray-200 hover:border-gray-300 p-2 overflow-hidden transition-all">
