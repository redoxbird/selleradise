...
<div x-data id="post-<?php the_ID();?>" <?php post_class("selleradise_postCard--default-sticky md:col-span-full lg:col-span-2 flex justify-start flex-wrap flex-col-reverse md:flex-row rounded-2xl border-1 border-solid border-gray-200 p-3 overflow-hidden");?>>
