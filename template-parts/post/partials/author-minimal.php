...
<div class="w-full mt-auto pt-6">
    <span class="entry-meta flex justify-start flex-wrap items-center gap-2 text-xs font-medium opacity-75">
      <?php echo THEME_NAMESPACE\Core\Tags::posted_on(); ?>
      <span class="author vcard leading-none">
        <a class="url fn n flex justify-start items-center text-text-900 hover:underline" href="<?php echo esc_url(get_author_posts_url($author_id)) ?>">
